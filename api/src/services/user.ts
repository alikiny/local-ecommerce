...
const updateAuthenticated = async(update: UserDocuments) => {
    ...
    const updated = await User.findByIdAndUpdate(update._id, update, {new: true})
...
export default {create, findOne, update, findOrCreate, findByEmail, findProfile, updateAuthenticated} 